...
## 질문 1. 인공지능 유망한 분야가 무엇인가요?
*답변: 유망한 분야를 정의하는 방식이 달라 하나로 정의하는 것이 어렵고 현재 돈을 잘 버는 분야라도 5년 뒤에 잘 번다고 장담할 수 없다. 
 그렇기에 학생이 관심있는 분야에 경험을 해보는 것이 중요하다고 하심.

## 질문 2. 대학원 공부 방향은 어떻게 잡아야 하나요?
* 답변: 프로그래밍 언어를 여러 개 하는 것보다 수학·알고리즘·자료구조 같은 기초를 탄탄히 하는 게 더 중요하다고 하심.  
  대학원에서는 문제를 정의하고 해결하는 능력이 핵심이라서 코드보다 논문 읽기와 분석 능력이 중요하다고 조언하심.

## 질문 3. 연구실은 어떤 기준으로 선택해야 하나요?
* 답변: 분위기보다 내가 하고 싶은 연구 주제를 먼저 정하고, 그 분야를 잘 하는 교수님을 찾으라고 하심.  
  연구실 규모, 논문 실적, 진행 중인 프로젝트 확인도 꼭 필요하다고 하심.

## 질문 4. 학부에서 어떤 준비를 하면 도움이 되나요?
* 답변: 기초를 확실히 하고, 작은 것이라도 직접 기획한 프로젝트가 가장 도움이 된다고 하심.  
  대학원에서는 스스로 문제를 만들고 해결하는 능력을 보기 때문에 규모보다 ‘내가 설계한 것’이 더 중요하다고 하심.

## 질문 5. 대학원 생활은 어떤가요?
* 답변: 자유로운 편이지만 그만큼 스스로 관리해야 할 게 많다고 하심.  
  연구는 멘탈 관리가 특히 중요하고, 실험과 개선 과정을 즐길 수 있어야 오래 버틸 수 있다고 하심.

# 느낀점
* 이번 상담을 통해 대학원 준비는 단순히 코딩 실력보다 기초 학문과 문제 해결 능력이 더 중요하다는 걸 알게 됨.  
  특히 연구 주제 선택과 연구실 기준을 명확히 해야 한다는 조언이 큰 도움이 되었음. 그리고 전공분야는 현재 가치보다
  자신이 얼마나 관심있냐에 달려있다고 느꼈다.
