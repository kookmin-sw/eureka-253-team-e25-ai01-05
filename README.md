...
■ 전공 선택 및 관심 분야 확립
┃ 저희 팀은 전공을 선택한 계기를 선배님께 설명드림
┃ 선배님은 학부 시절부터 관심 분야를 명확하게 설정하는 것이 중요하다고 강조
┃ “하고 싶은 분야를 일찍 정해두면 학업 계획과 취업 준비에 큰 도움이 된다”고 조언

■ 게임 개발 분야 관련 조언
┃ 게임 분야는 학년이 올라갈수록 선택 학생이 줄어드는 경향이 있다고 설명
┃ 이는 경쟁이 줄어드는 대신, 꾸준한 실력 향상이 중요함을 의미
┃ 실제 취업 준비 선배들은 “1학년 때부터 코딩 테스트 준비했어야 했다”는 후회를 많이 함
┃ 알고리즘 문제풀이 및 코딩 테스트 준비의 필요성 강조

■ 코딩 흥미 부족 학생을 위한 학습 방법
┃ 큰 프로젝트를 직접 만들지 않아도 됨
┃ 작은 프로그램을 AI나 구글링으로 완성해보는 경험이 흥미를 키우는 데 효과적
┃ 오류 수정 과정, 기능 보완 과정 자체가 코딩에 대한 흥미를 자연스럽게 증가시킴

■ 군 복무 중 공부 방법
┃ 군대에서는 코딩 문제풀이가 가장 현실적이고 효과적이라고 조언
┃ 시간·장소 제약이 있어도 온라인 문제풀이 플랫폼을 활용하면 실력 유지 가능
┃ 꾸준히 알고리즘 문제를 풀어보는 학습 전략 추천

◆ 상담을 통해 얻은 점

┃ 이번 상담을 통해 팀원 모두 전공 선택의 의미를 다시 돌아볼 수 있었음
┃ 앞으로 학습 계획을 어떻게 세워야 할지 명확한 방향성을 얻게 됨
┃ 코딩 테스트 준비의 중요성을 확실히 인식
┃ 작은 프로젝트 경험이 얼마나 중요한지 깨닫게 된 유익한 시간
...
유레카 지도교수님 만나기 과제
Q1. AI 분야가 너무 넓은데, 흥미 분야는 어떻게 찾으면 좋을까?

교수님께서는 학교 홈페이지에 게시된 교수님들의 연구 논문을 찾아보고,
ChatGPT를 활용해 내용을 요약하며 공부해보는 방식을 추천하셨다.
이렇게 간접적으로 여러 연구 분야를 경험하면서 어떤 주제가 실제로 재미있는지 스스로 탐색하는 것이 좋다고 하셨다.

Q2. 진로 선택에서 흥미만 고려해도 괜찮을까?

흥미뿐 아니라 시장 수요와 성장 가능성까지 함께 고려해야 한다고 강조하셨다.
4년 동안 열심히 공부했는데 해당 분야의 수요가 적어 취업이 어려워진다면 매우 난감한 상황이 될 수 있으므로,
전망이 좋은 분야 중에서 흥미를 찾는 것이 현명한 선택이라고 조언하셨다.

Q3. 스펙(대회·자격증·활동)은 어떻게 준비하는 것이 좋을까?

대회는 유명하고 공신력 있는 큰 대회에서 수상하는 것이 가장 효과적

활동은 대기업 등 공신력 있는 기관의 인턴 경험이 가장 도움이 됨
소규모 대회나 활동은 차별점이 크게 되지 않을 수 있다고 말씀하셨다.

Q4. 코딩 실력은 얼마나 중요한가?

코딩 실력은 어느 정도 수준을 넘어서면 큰 차이를 만들기 어렵다고 하셨다.
그보다 중요한 것은
...
이 두 가지가 진짜 경쟁력이라고 강조하셨다.

Q5. 전공 수학은 AI 연구에서 어떻게 활용될까?

AI 알고리즘은 선형대수, 미적분, 확률통계 같은 전공 수학을 기반으로 작동한다.
수학을 좋아한다면, 이러한 전공 수학 개념들이 AI 모델에서 어떤 방식으로 쓰이는지 공부해보고
이를 블로그에 기록해 나만의 포트폴리오로 만드는 것을 추천하셨다.

느낀 점

이번 상담을 통해 진로를 결정할 때 흥미와 시장성의 균형이 매우 중요함을 깨달았다.
또한 단순한 코딩 실력보다 이론과 수학적 깊이가 더 강력한 차별점이라는 조언이 큰 도움이 되었다.
앞으로 어떤 방향으로 공부를 이어가야 할지 명확해지는 유익한 시간이었다.
